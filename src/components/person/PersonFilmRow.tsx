...
/**
 * One film on a person's page: {@link EntityFilmRow} plus what they did on it and the tier
 * that reaches it — the two things a studio and a franchise have no equivalent of.
 *
