  ...
  return (
    <div className="mt-4 rounded-lg border border-border p-4">
      ...
      <p className="mt-1 text-xs text-muted-foreground">
        Connect your TMDB account and we will read your TMDB watchlist, then show you the films on
        it before anything is followed. You approve it on TMDB — we never see your password, and we
        drop the connection as soon as the import is done.
      </p>
