 ...
 *  paying for, then the two that cost money today. The labels are the watchlist's alert-pref
 *  vocabulary (D-14) — "Stream" for TMDB's `flatrate` — so the word means the same thing on
 *  both surfaces. */
